...
/* ============================================================
 * Function pointer callbacks (set by active machine)
 * ============================================================ */

m6809_read_fn_t m6809_read_fn = 0;
m6809_write_fn_t m6809_write_fn = 0;
m6809_read_fn_t m6809_opcode_fn = 0;

uint8_t m6809_read(m6809_state *s, uint16_t addr) {
    return m6809_read_fn(addr);
}

void m6809_write(m6809_state *s, uint16_t addr, uint8_t val) {
    m6809_write_fn(addr, val);
}

uint8_t m6809_read_opcode(m6809_state *s, uint16_t addr) {
    return m6809_opcode_fn(addr);
}
