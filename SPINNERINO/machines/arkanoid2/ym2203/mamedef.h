...
// SPINNERINO/ESP32: ESP32-S3/P4 sono little-endian → forzo VGM_LITTLE_ENDIAN
// così BYTE_XOR_BE() definito sotto si risolve correttamente.
#ifndef VGM_LITTLE_ENDIAN
#define VGM_LITTLE_ENDIAN 1
#endif
